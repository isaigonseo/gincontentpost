        ...
        if isinstance(block, Table):
            ...
            if line_slug in image_map:
                ...
                try:
                    ...
                    if media_id:
                        img_html = f'<!-- wp:image {{"align":"center","id":{media_id},"sizeSlug":"full"}} -->\n<figure class="wp-block-image aligncenter size-full"><img src="{img_url}" alt="{alt_text}" class="wp-image-{media_id}"/><figcaption class="wp-element-caption">{alt_text}</figcaption></figure>\n<!-- /wp:image -->'
                    else:
                        img_html = f'<!-- wp:image {{"align":"center"}} -->\n<figure class="wp-block-image aligncenter"><img src="{img_url}" alt="{alt_text}"/><figcaption class="wp-element-caption">{alt_text}</figcaption></figure>\n<!-- /wp:image -->'
